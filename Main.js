...
var x = charX;
    ...
    var removePortfolio = function () {
            ...
            setTimeout(function () {
                $(stripe).removeClass("portfolioEle");
                $(seg1).removeClass("portfolioEle");
                $(seg2).removeClass("portfolioEle");
                }, 1000);
    };
    ...
    $(portfolio).on('click', function () {
        removeAbout();
        removeContact();
        $(stripe).addClass("portfolioEle");
        $(seg1).addClass("portfolioEle");
        $(seg2).addClass("portfolioEle");
            setTimeout(function(){
